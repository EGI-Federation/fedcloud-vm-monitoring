         ...
         for item in endpoints.findall('SERVICE_ENDPOINT'):
             ...
             if 'Y' in production and 'Y' in monitored:
                ...
                try:
                    ...
                    print(colourise("green", "- No.%d project(s) supported by the provider: %s" \
                    ...
                    for project in projects:
                        ...
                        if (TENANT_NAME in project_name):
                           print(colourise("yellow", "- Project tenant published by the provider."))
                           ...
                           for endpoint in endpoints:
                               ...
                               for url in urls:
                                   ...
                                   if "public" in endpoint_interface and "nova" in endpoint_name:
